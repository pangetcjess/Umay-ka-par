...
module.exports.run = async ({ event, api, args, Users }) => {
  ...
  var path_poutine = __dirname + "/cache/poutine.png";
  fs.writeFileSync(path_poutine, attach.attachment);
  api.sendMessage({attachment: fs.createReadStream(path_poutine)}, event.threadID, () => fs.unlinkSync(path_poutine), event.messageID);
}