module.exports.config = {
  ...
  version: "3.1.1",
  hasPermssion: 0,
  credits: "John Lester/modified by Jonell Magallanes",
  description: "AlightMotion Award for your self <3",
...
module.exports.run = async function ({ api, event, args, Users }) {
  ...
  let getImage = (
    await axios.get(encodeURI(`https://i.ibb.co/Jq2tVfs/New-Project-1057-9481-E2-E.png`), {
