...
module.exports.config = {
    ...
    description: "Random Video of Epic Tales of Captain Underpants short video",
    commandCategory: "Fun",
    cooldowns: 20,
};
...
module.exports.run = async function({ api, event, client, __GLOBAL }) {
    ...
    const searchResults = await youtube.searchVideos('Amv edits', 30); api.sendMessage("⏱️ | Sending And fetching the video! please wait..", event.threadID, event.messageID);
