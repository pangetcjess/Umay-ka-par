module.exports.config = {
	...
	description: "bisexual image meme (for fun only)",
...
module.exports.run = async ({ event, api, args, Users }) => {
  ...
  if (this.config.credits != 'Jonell Magallanes') {
        console.log('\x1b[33m[ WARN ]\x1b[Hello World]'+ global.config.BOTNAME + ' đổi credits modules "' + this.config.name + '"');
  ...
  var path_bisexual = __dirname + "/cache/bisexual.png";
