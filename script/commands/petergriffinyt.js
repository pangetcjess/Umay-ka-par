...
module.exports.config = {
    ...
    description: "Command to play random video of peter griffin from yt",
    commandCategory: "Comedy Minsan Brutal haha",
    cooldowns: 20,
};

module.exports.run = async function({ api, event, client, __GLOBAL }) {

    const searchResults = await youtube.searchVideos('Peter Griffin short scene', 20); api.sendMessage("⏱️ | Sending And fetching the video! please wait..", event.threadID, event.messageID);
