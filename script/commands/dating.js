...
module.exports.handleReaction = async function({ api, event, Threads, Users, Currencies, handleReaction }) {
    ...
    switch (turn) {
        case "match":
            ...
            await Currencies.setData(senderID, { money: coin - 0 });
...
module.exports.run = async function({ api, event, args, Users, Currencies }) {
    ...
    if (money < 0) return api.sendMessage(`𝐁𝐚̣𝐧 𝐜𝐚̂̀𝐧 𝟐𝟎𝟎𝟎 𝐕𝐍𝐃 𝐜𝐡𝐨 𝐦𝐨̣̂𝐭 𝐜𝐚́𝐢 𝐝𝐚𝐭𝐢𝐧𝐠 𝐯𝐨̛́𝐢 𝐦𝐨̣̂𝐭 𝐧𝐠𝐮̛𝐨̛̀𝐢 💸`, threadID, messageID);
