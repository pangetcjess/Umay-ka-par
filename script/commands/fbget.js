module.exports.config = {
	...
	hasPermssion: 0,
	credits: "aizen code",
	description: "fbget [user] [mentioned]",
...
if (!args[0]) return api.sendMessage(`\n\n${prefix}fbget id [id to get] <get image by person uid>\n\n${prefix}fbget link [link to get] <get by that person's link>\n\n${prefix}fbget user <leave blank is get avatar of the command user>\n\n${prefix}fbget user [@mentions] <get avatar of person tagged>`,event.threadID,event.messageID);
else if (args[0] == "id") {
	try {
	var id = args[1];
