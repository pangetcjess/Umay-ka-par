...
module.exports.handleEvent = async ({
	...
	["Gandu", "stupid bot", "chicken bot", "bots lol", "dog", "dog bot", "bekar bot", "fuck bot", "dmm bot", "mc bot", "bakwas bot", "land bot", "crazy", "bc bot", "bot poke", "fuck", "fuck you", "harami", "haram khor", "shame bot", "fucking", "kutta", "donky", "sex", "sexy", "sexy picture", "sex porn", "xxx", "hot bot", "behenchod", "hate you bot", "bot lồn", "mera loda", "mera lund", "lon", "bot như cc", "bot như bìu", "Bot sida", "bot sida", "bot fake", "Bảo ngu", "bot shoppee", "bad bots", "bot cau"].forEach((a => {
