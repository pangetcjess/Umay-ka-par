...
3: Do not abuse bots for malicious purpose.,...
4:Do not Abuse when using Ai Command for nonsense question instead you can use sim command
5: More updates\n\nTHANKYOU USING THIS BOT\n\n\nADMIN BOT:JONELL MAGALLANES .`, event.threadID, event.messageID);