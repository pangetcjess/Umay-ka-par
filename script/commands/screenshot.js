...
module.exports.run = async ({ event, api, args, }) => {
    ...
    if (global.moduleData.pornList.some(pornURL => urlParsed.host == pornURL)) return api.sendMessage("The site you entered is not secure!", event.threadID, event.messageID);
